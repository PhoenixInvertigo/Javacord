...
public abstract class BasicServerVoiceChannelImpl extends ServerChannelImpl
        implements BasicServerVoiceChannel, InternalServerVoiceChannelAttachableListenerManager {
     ...
     */
    public BasicServerVoiceChannelImpl(DiscordApiImpl api, ServerImpl server, JsonNode data) {
