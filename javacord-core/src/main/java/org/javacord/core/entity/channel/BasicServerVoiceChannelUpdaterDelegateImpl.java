...
public class BasicServerVoiceChannelUpdaterDelegateImpl extends ServerChannelUpdaterDelegateImpl
     ...
     */
    protected BasicServerVoiceChannelUpdaterDelegateImpl(ServerChannel channel) {
        super(channel);
    }
